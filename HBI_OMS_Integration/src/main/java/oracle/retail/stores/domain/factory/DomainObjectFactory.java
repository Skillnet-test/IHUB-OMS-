    ...
    implements DomainObjectFactoryIfc
{
    ...
    **/
    ...
    public TenderSwitchIfc getTenderSwitchInstance()
    {
        return getTenderSwitchInstance(getLocale());
    } 
    
    public TenderSoloIfc getTenderSoloInstance()
    {
        return getTenderSoloInstance(getLocale());
    } 
    
    public TenderPOSIfc getTenderPOSInstance()
    {
        return getTenderPOSInstance(getLocale());
    } 
    
    public TenderReplacementOrderIfc getTenderReplacementOrderInstance()
    {
        return getTenderReplacementOrderInstance(getLocale());
    } 
