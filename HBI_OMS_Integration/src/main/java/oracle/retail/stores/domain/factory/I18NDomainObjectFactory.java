...
import oracle.retail.stores.domain.tender.TenderPOS;
import oracle.retail.stores.domain.tender.TenderPOSIfc;
...
import oracle.retail.stores.domain.tender.TenderReplacementOrder;
import oracle.retail.stores.domain.tender.TenderReplacementOrderIfc;
import oracle.retail.stores.domain.tender.TenderSolo;
import oracle.retail.stores.domain.tender.TenderSoloIfc;
...
import oracle.retail.stores.domain.tender.TenderSwitch;
import oracle.retail.stores.domain.tender.TenderSwitchIfc;
...
public abstract class I18NDomainObjectFactory extends I18NDomainObjectsFactory
{
   ...
   /**
    ...
    public TenderSwitchIfc getTenderSwitchInstance(Locale locale)
    {
        return new TenderSwitch();
    }
    
    public TenderSoloIfc getTenderSoloInstance(Locale locale)
    {
        return new TenderSolo();
    }
    
    public TenderPOSIfc getTenderPOSInstance(Locale locale)
    {
        return new TenderPOS();
    }
    
    public TenderReplacementOrderIfc getTenderReplacementOrderInstance(Locale locale)
    {
        return new TenderReplacementOrder();
    }
