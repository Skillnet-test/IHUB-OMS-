...
public interface NbtyARTSDatabaseIfc extends ARTSDatabaseIfc
{
    ...
    //Pos Return Order Info Webservice
    public static final String TABLE_POS_RTLOG_GENERATED="POS_RTLOG_GENERATED";
    
    public static final String FIELD_WEB_ORDER_LINE_ITEM_SHIPTO_NO= "IDT_SEQ_NBR";
